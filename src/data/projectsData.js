...
export const projectsData = [
  {
    ...
    projectName: "MONETA",
    projectDesc:
      "MONETA (Monitoring Kinerja dan Tugas) adalah sistem berbasis web yang dikembangkan di PT. Carefast Divisi Millennium Centennial Center yang bergerak di bidang jasa layanan kebersihan, bertujuan meningkatkan produktivitas, transparansi, dan kualitas layanan.",
    tags: ["Laravel 12", "HTML", "CSS", "Javascript", "SBAdmin2"],
    code: "#",
    demo: "#",
    image:
      "https://github.com/foster2002150902/Images/blob/1c70b19de61038f40f3caad7baee4ee79d49ce40/Screenshot%202025-08-12%20193615.png",
  },
  {
    id: 2,
    projectName: "Booking Tiket Bioskop",
    projectDesc:
      "Sistem Booking Tiket Bioskop adalah platform digital yang memungkinkan pengguna memilih film, jadwal tayang, kursi, dan melakukan pembayaran secara online untuk memesan tiket bioskop dengan cepat dan praktis.",
